...
type DBClient interface {
	...
	Like(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *dBClient) Like(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
type DBServer interface {
	...
	Like(context.Context, *UserRequest) (*UserResponse, error)
...
func (UnimplementedDBServer) Like(context.Context, *UserRequest) (*UserResponse, error) {
